...
namespace RegionSyd.Web.Services
{
    public class BedService : IBedService
    {
        ...
        public async Task<BedDTO> Create(BedDTO bedDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PostAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(bedDTO), Encoding.UTF8, "application/json"));
        ...
        public async Task<BedDTO> Update(BedDTO bedDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PutAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(bedDTO), Encoding.UTF8, "application/json"));

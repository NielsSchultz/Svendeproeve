...
namespace RegionSyd.Web.Services
{
    public class DepartmentService : IDepartmentService
    {
        ...
        public async Task<DepartmentDTO> Create(DepartmentDTO departmentDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PostAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(departmentDTO), Encoding.UTF8));
        ...
        public async Task<DepartmentDTO> Update(DepartmentDTO departmentDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PutAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(departmentDTO), Encoding.UTF8));

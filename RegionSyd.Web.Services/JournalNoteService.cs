...
namespace RegionSyd.Web.Services
{
    public class JournalNoteService : IJournalNoteService
    {
        ...
        public async Task<JournalEntryNoteDTO> Create(JournalEntryNoteDTO journalNoteDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PostAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(journalNoteDTO), Encoding.UTF8, "application/json"));
        ...
        public async Task<JournalEntryNoteDTO> Update(JournalEntryNoteDTO journalNoteDTO)
        {
            ...
            var httpResponseMessage = await httpClient.PutAsync($"{httpClient.BaseAddress}{CONTROLLER}", new StringContent(JsonConvert.SerializeObject(journalNoteDTO), Encoding.UTF8, "application/json"));
